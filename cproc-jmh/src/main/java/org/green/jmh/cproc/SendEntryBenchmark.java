...
public class SendEntryBenchmark {
    public abstract static class AbstractProcessSetup {
        ...
        DefaultConcurrentProcess
            <LongEntry, Executor<LongEntry>, ConcurrentProcessListener<LongEntry, Executor<LongEntry>>>
            process;

        @Setup(Level.Trial)
        public void doSetup() {
            executor = new DefaultExecutor(SendEntryBenchmark.class.getSimpleName() + "'s exec") {
            };
    ...
    public void singleSenderWithBlockingCab(
    ...
    @Warmup(iterations = 3)
    @BenchmarkMode(Mode.Throughput)
    public void twoSenderWithBlockingCab(
        final CabBlockingBasedProcessSetup processSetup,
        final EntrySenderSetup entrySetup)
        throws ConcurrentProcessClosedException, InterruptedException {
    ...
    @Warmup(iterations = 3)
    @BenchmarkMode(Mode.Throughput)
    public void singleSenderWithBackingOffCab(
    ...
    @Warmup(iterations = 3)
    @BenchmarkMode(Mode.Throughput)
    public void twoSendersWithBackingOffCab(
        final CabBackingOffBasedProcessSetup processSetup,
        final EntrySenderSetup entrySetup)
        throws ConcurrentProcessClosedException, InterruptedException {
    ...
    @Warmup(iterations = 3)
    @BenchmarkMode(Mode.Throughput)
    public void singleSenderWithYieldingCab(
    ...
    @Warmup(iterations = 3)
    @BenchmarkMode(Mode.Throughput)
    public void twoSendersWithYieldingCab(
        final CabYieldingBasedProcessSetup processSetup,
        final EntrySenderSetup entrySetup)
        throws ConcurrentProcessClosedException, InterruptedException {
