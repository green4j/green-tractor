...
public class EntryProducerBenchmark extends CabBenchmark {
    ...
    @Benchmark
    @Threads(1)
    public void oneEntryProducerWithCabBusySpinning(
            final CabBusySpinningSetup cabSetup, final Blackhole blackhole)
            throws ConsumerInterruptedException, InterruptedException {

        final Cab<Object, Object> cab = cabSetup.cab;
    ...
    @Benchmark
    @Threads(2)
    public void twoEntryProducersWithCabBusySpinning(
            final CabBusySpinningSetup cabSetup, final Blackhole blackhole)
            throws ConsumerInterruptedException, InterruptedException {
